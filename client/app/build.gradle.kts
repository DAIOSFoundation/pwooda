...
android {
    ...
    defaultConfig {
        ...
        // BuildConfig에 Gemini API 키 추가
        // local.properties 파일에서 GEMINI_API_KEY를 읽어옴
        ...
        val liveKitTokenServerUrl = localProperties.getProperty("LIVEKIT_TOKEN_SERVER_URL", "http://10.0.2.2:8081")
        val useLiveKit = localProperties.getProperty("LIVEKIT_USE_LIVEKIT", "false")

        buildConfigField("String", "GEMINI_API_KEY", "\"$geminiApiKey\"")
        buildConfigField("String", "TAVILY_API_KEY", "\"$tavilyApiKey\"")
        buildConfigField("String", "LIVEKIT_TOKEN_SERVER_URL", "\"$liveKitTokenServerUrl\"")
        buildConfigField("boolean", "USE_LIVEKIT", useLiveKit)
    }
...
dependencies {
    ...
    // LiveKit Android SDK for real-time voice chat
